...
##'
##' First of all, before using the \pkg{UrbanTempo} package, you need to define your research question and choose the urban location you are interested in.
...
##' Such appearances should be saved into a "plain text" file, which can then be loaded via the \code{\link{readAppearances}} function.
##'
