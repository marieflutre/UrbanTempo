...
It is part of the R package [UrbanTempo](https://github.com/marieflutre/UrbanTempo):
```{r load_pkg}
library(UrbanTempo)
```
...
To add the legend, such a file can be edited with [Inkscape](https://inkscape.org) (free software).
